...
../Kamek/bin/Debug/Kamek kamekLoader.o nsmbw.o -static=0x80001800 -output-code=loader.bin -output-riiv=loader.xml -input-dol=nsmbw_pal.dol -output-dol=nsmbw_pal_kamek.dol
